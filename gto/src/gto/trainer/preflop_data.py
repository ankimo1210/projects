...
_BTN_RAISE = set(ALL_HANDS) - {
    ...
    "65o","75o","85o","95o","T5o","J5o","Q5o",
    "76o","86o","96o","T6o","J6o","Q6o",
    "87o","97o","T7o","J7o",
    "98o","T8o","J8o",
    "T9o",
}
...
def _face(threeb: set[str], call: set[str], mixed3: dict[str, float] | None = None) -> dict[str, dict]:
    result = {}
    for h in ALL_HANDS:
        if h in threeb:
...
_BB_CO_CALL = {
    ...
    "JTs","J8s",
    "T8s","T7s",
    "97s","96s","86s","85s","75s","64s","54s","43s",
    "AJo","ATo","A9o","A8o",
    "KQo","KJo","KTo",
    "QJo","QTo",
    "JTo","J9o","T9o","98o",
