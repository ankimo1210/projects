...
// ---------------------------------------------------------------------------
// Types (mirror src/gto/api/routers/review.py)
// ---------------------------------------------------------------------------
...
export async function parseHandHistory(text: string): Promise<ParseResponse> {
  const res = await fetch(`${BASE}/api/review/parse`, {
    method: "POST",
