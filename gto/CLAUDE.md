...
| HU solver | `crates/gto-hu/` | Abstract HU NLHE equilibrium solver: vector CFR+, Kuhn/Leduc validation, exact best response. CLIs: `solve-hu-river`, `solve-hu-turn-river`, `solve-hu-flop`, `solve-hu-preflop` |
