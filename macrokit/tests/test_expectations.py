...
from helpers import _event, _obs, _rates, con  # noqa: F401 -- `con` is a fixture
...
def test_random_walk_takes_the_prior_quarter_as_it_stood_before_the_release(con):  # noqa: F811 -- `con` fixture imported from helpers
...
def test_random_walk_has_no_expectation_for_the_oldest_release(con):  # noqa: F811 -- `con` fixture imported from helpers
...
def test_prior_vintage_anchors_the_second_preliminary_on_the_first(con):  # noqa: F811 -- `con` fixture imported from helpers
    may = datetime(2026, 5, 18, 8, 50, tzinfo=JST)
    june = datetime(2026, 6, 8, 8, 50, tzinfo=JST)
...
def test_prior_vintage_does_not_apply_to_a_first_preliminary(con):  # noqa: F811 -- `con` fixture imported from helpers
    august = datetime(2026, 8, 17, 8, 50, tzinfo=JST)
    _obs(con, date(2026, 4, 1), august, 1.1, 1)
    _rates(con, date(2026, 8, 14), date(2026, 8, 17))
...
def test_previous_business_day_uses_market_rates_not_a_holiday_calendar(con):  # noqa: F811 -- `con` fixture imported from helpers
...
def test_no_expectation_reads_a_vintage_released_at_or_after_its_event(con):  # noqa: F811 -- `con` fixture imported from helpers
    august = datetime(2026, 8, 17, 8, 50, tzinfo=JST)
    june = datetime(2026, 6, 8, 8, 50, tzinfo=JST)
