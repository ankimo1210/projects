"""Guard: MODEL_INDEX.md lists every deep_hedge_price module and refs resolve."""
...
def test_module_listed(module: str) -> None:
    assert f"deep_hedge_price.{module}" in TEXT, (
        f"deep_hedge_price.{module} missing from MODEL_INDEX.md"
    )
