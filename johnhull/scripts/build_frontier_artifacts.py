"""Build vol 19--28 references from the tested implementation APIs."""
...
FILES = {
    ...
    28: ("28_credit_desk", "metrics.json", "credit_scenarios.npz"),
}
...
UNITS_BY_VOLUME: dict[int, dict[str, str]] = {
    21: {
        ...
        "teacher_future": "VIX index points",
        "price_lower_bound": "synthetic monetary units",
        "price_upper_bound": "synthetic monetary units",
        "monotonicity_scale": "normalized features",
        "teacher_scale_price": "synthetic monetary units",
        "surrogate_scale_price": "synthetic monetary units",
    ...
    22: {
        ...
        "event_jump_intensity": "annualized jump intensity",
        "non_event_jump_intensity": "annualized jump intensity",
    ...
    24: {
        ...
        "liquidation_method_fee": "synthetic monetary units",
        "liquidation_method_trader_return": "synthetic monetary units",
        "liquidation_method_insurance_before": "synthetic monetary units",
        "liquidation_method_insurance_after": "synthetic monetary units",
    ...
    26: {
        ...
        "yoy_start_forward_cpi": "synthetic CPI index points",
        "yoy_end_forward_cpi": "synthetic CPI index points",
        "yoy_start_payment_adjustment": "log CPI multiplier",
        "yoy_end_payment_adjustment": "log CPI multiplier",
        "yoy_start_log_variance": "log CPI variance",
        "yoy_log_covariance": "log CPI covariance",
        ...
        "jgbi_unfloored_coupon": "currency units per 100 face",
        ...
        "unhedged_risk": "currency units per 100 face per risk unit (1bp nominal shift, 1 CPI point)",
        "hedge_instrument_names": "label",
        "hedge_instrument_risk": "currency units per unit notional per risk unit (1bp nominal shift, 1 CPI point)",
        "hedge_notional": "units of 100-face hedge instrument",
        "hedged_risk": "currency units per 100 face per risk unit (1bp nominal shift, 1 CPI point)",
        "hedge_scenario_names": "label",
        "unhedged_scenario_pnl": "currency units per 100 face",
        "hedged_scenario_pnl": "currency units per 100 face",
    ...
    27: {
        ...
        "factor_names": "label",
        "position_names": "label",
        "position_weights": "position units",
        "position_factor_delta": "P&L per factor unit",
        "position_factor_gamma": "P&L per factor unit squared",
        "position_factor_vega": "P&L per volatility unit",
        "position_base_value": "position value amount",
        "position_shocked_value": "position value amount",
        "position_full_pnl": "full-revaluation P&L amount",
        "position_full_pnl_half": "full-revaluation P&L amount",
