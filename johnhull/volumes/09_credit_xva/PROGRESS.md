...
- `credit_xva.ipynb` (34 cells, 2026-09-14) generated by `build_credit_notebook.py`
...
- KMV EDF: md only (Moody's data). CreditMetrics, base correlation and netting/collateral
  CVA are implemented in vol 28 (`hullkit.credit_metrics`, `credit_portfolio`, `xva`).
