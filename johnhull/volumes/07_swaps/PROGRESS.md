...
- `swaps.ipynb` (33 cells, 2026-09-14) generated by `build_swaps_notebook.py`
...
- hullkit addition: `swaps.py` (discount, swap_rate, irs_value_bonds,
  irs_value_fras, currency_swap_value — 6 tests at the time, 10 in `test_swaps.py` as of 2026-09-14; suite 68)
