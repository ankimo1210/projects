...
| M3 | §26.11の要求抽出から教材・図・実画面まで確認 | M3a：L01–L06、独立128価格・計132テストを完了。M3bの教材・図・配布画面は未着手 |
...
M3aの現在地は[§26.11の要求と残課題](docs/SECTION_26_11_REVIEW_2026-09-15.md)。
台帳は受入済み2、不足あり1、未評価303。M3aは価格の独立検証で、§26.11の受入完了ではない。
