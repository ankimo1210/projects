...
| 節カバレッジ | [節別台帳](docs/SECTION_LEDGER.md)へ306項目を登録。§26.9–§26.12の4項目受入、302項目未評価。M4bの最終統合判定は受入ノートと統合記録を参照。完了率は確定値として使わない |
...
現在地は[§26.12受入ノート](docs/SECTION_26_12_ACCEPTANCE_2026-09-16.md)と
[M4b統合記録](docs/validation/section-26-12/m4b-check.json)。台帳は受入4・不足0・未評価302。
...
次節は§26.13の要求抽出と独立基準の確認から始める。既存Asian実装の存在を受入判定へ流用しない。
