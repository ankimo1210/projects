...
| 節カバレッジ | [節別台帳](docs/SECTION_LEDGER.md)へ306項目を登録。§26.9・§26.10・§26.11の3項目受入、303項目未評価。M3b最終ブランチレビューも承認済み。完了率は確定値として使わない |
...
M3bの現在地は[§26.11受入ノート](docs/SECTION_26_11_ACCEPTANCE_2026-09-16.md)と
