...
| M6 | §26.14 Options to Exchange One Asset for Another（p.627）を要求整理から配布画面まで | 未着手。既存`exchange_option`はMargrabeの1本で、独立検証・教材・図・実画面は未確認 |
...
次は原典順に**§26.14 Options to Exchange One Asset for Another**（p.627）へ進む。
