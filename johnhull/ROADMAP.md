...
| 節カバレッジ | [節別台帳](docs/SECTION_LEDGER.md)へ306項目を登録。§26.9–§26.16の8項目受入、298項目未評価。最終統合判定は各受入ノートと統合記録を参照。完了率は確定値として使わない |
...
現在地（2026-09-25）は[§26.16のM8](docs/SECTION_26_16_ACCEPTANCE_2026-09-25.md)。台帳は受入8・未評価298。
