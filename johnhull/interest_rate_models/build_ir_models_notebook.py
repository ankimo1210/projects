...
cells.append(md(r"""# 金利モデル比較・学習ノートブック
...
cells.append(code(r"""# --- モデル分類ツリー（plotly Treemap） ---
labels = [
    "金利モデル",
...
cells.append(md(r"""## 共通マーケットデータ（4 カーブパターン）
...
cells.append(code(r"""# --- 4 カーブパターン表示（matplotlib） ---
...
# --- 1.1 Vasicek ---
cells.append(md(r"""## 1.1 Vasicek モデル（1977）
...
cells.append(code(r"""# --- Vasicek SDE: Euler-Maruyama シミュレーション ---
...
# --- 1.2 CIR ---
cells.append(md(r"""## 1.2 CIR モデル（Cox-Ingersoll-Ross, 1985）
...
cells.append(code(r"""# --- CIR simulation ---
...
cells.append(md(r"""## 1.3 Rendleman–Bartter モデル
...
cells.append(code(r"""# --- Rendleman-Bartter simulation ---
...
cells.append(code(r"""# --- 均衡3モデル比較: 解析的平均パス ± 1σ（インタラクティブ） ---
...
# --- 2.1 Ho-Lee ---
cells.append(md(r"""## 2.1 Ho–Lee モデル（1986）
...
cells.append(code(r"""# --- Ho-Lee calibration ---
...
# --- 2.2 Hull-White ---
cells.append(md(r"""## 2.2 Hull–White モデル（1990）
...
cells.append(code(r"""# --- Hull-White calibration and zero curve ---
...
cells.append(code(r"""# --- Hull-White: simulated short-rate paths ---
...
# --- 2.3 BDT ---
cells.append(md(r"""## 2.3 Black–Derman–Toy モデル（1990）
...
cells.append(code(r"""# --- BDT ツリー（σ スライダーでノードレートが変化） ---
...
# --- 2.4 BK ---
cells.append(md(r"""## 2.4 Black–Karasinski モデル（1991）
...
cells.append(code(r"""# --- Black-Karasinski: simulated short-rate paths ---
...
cells.append(code(r"""# --- 無裁定4モデル比較: パス動態の違い（インタラクティブ） ---
...
cells.append(md(r"""## 3.1 HJM フレームワーク（Heath-Jarrow-Morton, 1992）
...
cells.append(code(r"""# --- HJM: Exponential volatility → Hull-White equivalence (interactive) ---
...
cells.append(md(r"""## 3.2 BGM / LIBOR Market Model（Brace-Gatarek-Musiela, 1997）
...
cells.append(code(r"""# --- BGM: Black caplet formula (interactive σ slider) ---
...
cells.append(code(r"""# --- HJM vs BGM/LMM: implied caplet vol テナー構造比較（インタラクティブ） ---
...
cells.append(code(r"""# --- Section 5: 5軸対比テーブル ---
comparison_data = {
    "比較軸": [
        "Vasicek vs CIR",
        "均衡 vs 無裁定",
...
cells.append(code(r"""# --- Section 6: 9×9 summary table ---
summary_data = {
...
cells.append(code(r"""# --- Section 7: Decision flowchart (Sankey diagram) ---
