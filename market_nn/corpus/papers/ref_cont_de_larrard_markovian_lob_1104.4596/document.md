...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0001" status="verified_source" source-page="5" -->
$$
\mathbb{P}[V_{i}^{a} = 1] = \dfrac{\lambda}{\lambda + \mu + \theta} and \mathbb{P}[V_{i}^{a} = -1] = \dfrac{\mu + \theta}{\lambda + \mu + \theta},
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0001](images/formula_0001.png)
*Formula quality: `verified_source`; source PDF page 5. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:347 (score=0.9836).*
<!-- formula-end -->

- (iv) ( V b i ) i ≥ 0 is a sequence of independent random variables with

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0002" status="verified_source" source-page="5" -->
$$
\mathbb{P}[V_{i}^{b} = 1] = \dfrac{\lambda}{\lambda + \mu + \theta} and \mathbb{P}[V_{i}^{b} = -1] = \dfrac{\mu + \theta}{\lambda + \mu + \theta}
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0002](images/formula_0002.png)
*Formula quality: `verified_source`; source PDF page 5. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:349 (score=0.9836).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0003" status="verified_source" source-page="7" -->
$$
(s_{T}^{b},q_{T}^{b},q_{T}^{a}) = (s_{T-}^{b},q_{T-}^{b},q_{T-}^{a} + V_{i}^{a}) 1_{q_{T-}^{a} > -V_{i}^{a}} + (S_{T-}^{b}+\delta,R_{i}^{b},R_{i}^{a}) 1_{q_{T-}^{a} \leq -V_{i}^{a}},
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0003](images/formula_0003.png)
*Formula quality: `verified_source`; source PDF page 7. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:425 (score=1.0).*
<!-- formula-end -->

- If an order or cancelation arrives on the bid side i.e. T ∈{ T b i , i ≥ 1 } :

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0004" status="verified_source" source-page="7" -->
$$
(s_{T}^{b},q_{T}^{b},q_{T}^{a}) = (s_{T-}^{b},q_{T-}^{b} + V_{i}^{b},q_{T-}^{a}) 1_{q_{T-}^{b} > -V_{i}^{b}} + (s_{T-}^{b}-\delta,\tilde{R}_{i}^{b},\tilde{R}_{i}^{a}) 1_{q_{T-}^{b} \leq -V_{i}^{b}},
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0004](images/formula_0004.png)
*Formula quality: `verified_source`; source PDF page 7. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:427 (score=1.0).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0005" status="verified_source" source-page="8" -->
$$
\sigma^{a} = \inf \lbrace T_i^a, \ q_{T_i^a-}^{a}+V^a_i = 0 \rbrace
\qquad \sigma^{b} = \inf \lbrace T_i^b, \ q_{T_i^b-}^{b}+V^b_i = 0 \rbrace
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0005](images/formula_0005.png)
*Formula quality: `verified_source`; source PDF page 8. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:467 (score=0.7407).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0006" status="verified_source" source-page="8" -->
$$
\tau = \sigma_{a} \wedge \sigma_{b}.
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0006](images/formula_0006.png)
*Formula quality: `verified_source`; source PDF page 8. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:470 (score=1.0).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0007" status="verified_source" source-page="8" -->
$$
\mathbb{P}[\tau >t| q_{0}^{a} = a, \ q_{0}^{b} = b] =
\sqrt{(\dfrac{\mu + \theta}{\lambda})^{a+b}} \psi_{a,\lambda,\theta+\mu}(t) \psi_{b,\lambda,\theta+\mu}(t)
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0007](images/formula_0007.png)
*Formula quality: `verified_source`; source PDF page 8. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:477 (score=0.9931).*
<!-- formula-end -->

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0008" status="verified_source" source-page="8" -->
$$
{\rm where}\qquad \psi_{n,\lambda,\theta+\mu}(t)=\int_{t}^{\infty} \dfrac{n}{u} I_{n}(2 \sqrt{\lambda (\theta+\mu)} u) e^{-u (\lambda + \theta+\mu)} du
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0008](images/formula_0008.png)
*Formula quality: `verified_source`; source PDF page 8. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:481 (score=0.9935).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0009" status="verified_source" source-page="8" -->
$$
\mathcal{L}(s,x) = \dfrac{\lambda \mathcal{L}(s,x+1) + (\mu + \theta) \mathcal{L}(s, x-1)}{\lambda + \mu + \theta + s} .
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0009](images/formula_0009.png)
*Formula quality: `verified_source`; source PDF page 8. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:501 (score=0.9882).*
<!-- formula-end -->

We can find the roots of the polynomial: λX 2 -( λ + µ + θ + s ) X + µ + θ ; one root is &gt; 1, the other is &lt; 1; since L ( s, 0) = 1 and lim x →∞ L ( s, x ) = 0,

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0010" status="verified_source" source-page="8" -->
$$
\mathcal{L}(s,x) = (\dfrac{(\lambda + \mu + \theta + s) - \sqrt{((\lambda + \mu + \theta + s))^{2} - 4\lambda (\mu + \theta)}}{2 \lambda})^{x}.
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0010](images/formula_0010.png)
*Formula quality: `verified_source`; source PDF page 8. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:503 (score=0.992).*
<!-- formula-end -->

Moreover if we use the relation P [ τ &gt; t | q a 0 = x,q b 0 = y ] = P [ σ a &gt;t | q a 0 = x ] P [ σ b &gt;t | q b 0 = y ],

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0011" status="verified_source" source-page="8" -->
$$
\mathbb{P}[\tau >t| q_{0}^{a} = x, q_{0}^{b} = y] = \int_{t}^{\infty} \hat{\mathcal{L}}(u,x) du \int_{t}^{\infty} \hat{\mathcal{L}}(u,y) du .
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0011](images/formula_0011.png)
*Formula quality: `verified_source`; source PDF page 8. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:506 (score=1.0).*
<!-- formula-end -->

This Laplace transform may be inverted (see (Feller 1971, XIV.7)) and the inversion yields

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0012" status="verified_source" source-page="8" -->
$$
\hat{\mathcal{L}}(t,x) = \dfrac{x}{t} \sqrt{(\dfrac{\mu + \theta}{\lambda})^{x}}\quad I_{x}(2 \sqrt{\lambda(\theta + \mu)} t) e^{-t (\lambda + \theta + \mu)},
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0012](images/formula_0012.png)
*Formula quality: `verified_source`; source PDF page 8. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:509 (score=0.9859).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0013" status="verified_source" source-page="8" -->
$$
\mathcal{L}(s,x) = \alpha(s)^{x} \mathop{\sim}_{ s \rightarrow 0} 1 - \dfrac{x(\lambda+ \mu+ \theta)}{2 \lambda(\mu + \theta - \lambda)} s,
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0013](images/formula_0013.png)
*Formula quality: `verified_source`; source PDF page 8. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:516 (score=0.8197).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0014" status="verified_source" source-page="9" -->
$$
\mathbb{P}[\sigma^{a} > t|q_{0}^{a} = x] \mathop{\sim}_{ t \rightarrow \infty} \dfrac{x(\lambda+ \mu+ \theta)}{2 \lambda(\mu + \theta- \lambda)} \dfrac{1}{t};
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0014](images/formula_0014.png)
*Formula quality: `verified_source`; source PDF page 9. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:518 (score=0.8707).*
<!-- formula-end -->

therefore the conditional law of the duration τ is a regularly varying with tail index 2

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0015" status="verified_source" source-page="10" -->
$$
\mathbb{P}[\tau > t|q_{0}^{a} = x, q_{0}^{b} = y] \mathop{\sim}_{ t \rightarrow \infty} \dfrac{xy(\lambda+ \mu+ \theta)^{2}}{ \lambda^{2}(\mu + \theta - \lambda)^{2}} \dfrac{1}{4t^2}.
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0015](images/formula_0015.png)
*Formula quality: `verified_source`; source PDF page 10. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:521 (score=0.7947).*
<!-- formula-end -->

- If the order flow is balanced i.e. λ = µ + θ then

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0016" status="verified_source" source-page="10" -->
$$
\mathcal{L}(s,x) =(\alpha(s))^{x} \mathop{\sim}_{ s \rightarrow 0} 1 - \dfrac{x}{\sqrt{\lambda}} \sqrt{s},
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0016](images/formula_0016.png)
*Formula quality: `verified_source`; source PDF page 10. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:523 (score=0.8352).*
<!-- formula-end -->

the law of σ a is regularly-varying with tail index 1 / 2 and

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0017" status="verified_source" source-page="10" -->
$$
\mathbb{P}[\sigma^{a} > t | q_{0}^{a} = x] \mathop{\sim}_{ t \rightarrow \infty} \dfrac{x}{\sqrt{\pi \lambda}} \dfrac{1}{\sqrt{t}}.
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0017](images/formula_0017.png)
*Formula quality: `verified_source`; source PDF page 10. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:525 (score=0.7581).*
<!-- formula-end -->

The duration then follows a heavy-tailed distribution with infinite first moment:

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0018" status="verified_source" source-page="10" -->
$$
\mathbb{P}[\tau > t| q_{0}^{a} = x, q_{0}^{b} = y] \mathop{\sim}_{ t \rightarrow \infty} \dfrac{xy}{\pi \lambda} \dfrac{1}{t};
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0018](images/formula_0018.png)
*Formula quality: `verified_source`; source PDF page 10. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:527 (score=0.8119).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0019" status="verified_source" source-page="10" -->
$$
\phi(n,p) = \dfrac{1}{\pi} \int_{0}^{\pi} (2-\cos(t)-\sqrt{(2-\cos(t))^2-1})^{p} \frac{\sin(nt) \cos(\frac{t}{2})}{\sin(\frac{t}{2})} dt.
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0019](images/formula_0019.png)
*Formula quality: `verified_source`; source PDF page 10. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:567 (score=0.9922).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0020" status="verified_source" source-page="10" -->
$$
...
*Formula quality: `verified_source`; source PDF page 10. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:573 (score=1.0).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0021" status="verified_source" source-page="10" -->
$$
f_{t}(x,y) = e^{xr(t)} \sin(yt), \qquad {\rm and} \qquad\tilde{f}_{t}(x,y) = e^{-xr(t)} \sin(yt)\qquad{\rm with}\quad r(t) = \cosh^{-1}(2 - \cos t)
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0021](images/formula_0021.png)
*Formula quality: `verified_source`; source PDF page 10. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:576 (score=1.0).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0022" status="verified_source" source-page="10" -->
$$
\dfrac{2}{\pi} \int_{0}^{\pi} e^{-r(t) p} \sin(nt) \sin(t x) dt,
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0022](images/formula_0022.png)
*Formula quality: `verified_source`; source PDF page 10. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:579 (score=0.9831).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0023" status="verified_source" source-page="11" -->
$$
\phi(n,p) = \sum_{k=1}^{\infty} \dfrac{2}{\pi} \int_{0}^{\pi} e^{-r(t) p} \sin(t n) \sin(t k) dt .
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0023](images/formula_0023.png)
*Formula quality: `verified_source`; source PDF page 11. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:581 (score=0.9888).*
<!-- formula-end -->

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0024" status="verified_source" source-page="11" -->
$$
\sum_{k=1}^{m} \sin(kt) = \dfrac{\sin(\frac{mt}{2})\sin(\frac{(m+1)t}{2})}{\sin(t/2)}=\dfrac{\cos(\frac{t}{2}) - \cos((m+\frac{1}{2})t)}{2 \sin(t/2)},
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0024](images/formula_0024.png)
*Formula quality: `verified_source`; source PDF page 11. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:583 (score=0.9861).*
<!-- formula-end -->

using integration by parts we see that the second term leads to the integral:

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0025" status="verified_source" source-page="11" -->
$$
\int_{0}^{\pi} \underbrace{\frac{e^{-r(t)p}\sin(nt)}{\sin(t/2)}}_{g(t)}\cos((m+1/2)t) dt= - \frac{1}{m+\frac{1}{2}}\int_{0}^{\pi} g'(t) \sin((m+\frac{1}{2})t) dt \mathop{\to}_{m\to\infty} 0.
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0025](images/formula_0025.png)
*Formula quality: `verified_source`; source PDF page 11. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:585 (score=0.7729).*
<!-- formula-end -->

since g ′ is bounded. So finally:

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0026" status="verified_source" source-page="11" -->
$$
\phi(n,p) = \dfrac{1}{\pi} \int_{0}^{\pi} e^{-r(t) p} \sin(t n) \frac{\cos(\frac{t}{2})}{\sin(\frac{t}{2})} dt .
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0026](images/formula_0026.png)
*Formula quality: `verified_source`; source PDF page 11. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:588 (score=0.9903).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0027" status="verified_source" source-page="11" -->
$$
N_{t} := \max \lbrace \ n \geq 0, \tau_{1} + ...+ \tau_{n} \leq t \ \rbrace
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0027](images/formula_0027.png)
*Formula quality: `verified_source`; source PDF page 11. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:615 (score=0.7857).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0028" status="verified_source" source-page="11" -->
$$
Z_{n} = \sum_{i=1}^{n} X_{i}
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0028](images/formula_0028.png)
*Formula quality: `verified_source`; source PDF page 11. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:617 (score=1.0).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0029" status="verified_source" source-page="11" -->
$$
p_{n}(x,y) := \mathbb{P}[X_{n} = \delta| q^{a}_{0} = x, \ q^{b}_{0} = y] = \dfrac{1+(2p_{cont}-1)^{n-1}(2p_{1}(x,y)-1)}{2},
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0029](images/formula_0029.png)
*Formula quality: `verified_source`; source PDF page 11. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:626 (score=0.9367).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0030" status="verified_source" source-page="13" -->
$$
\begin{pmatrix} p_{n} \\ 1-p_{n} \end{pmatrix} = \begin{pmatrix}
p_{cont}&1-p_{cont} \\
1-p_{cont}&p_{cont}
\end{pmatrix} \begin{pmatrix} p_{n-1} \\ 1-p_{n-1} \end{pmatrix},
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0030](images/formula_0030.png)
*Formula quality: `verified_source`; source PDF page 13. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:631 (score=1.0).*
<!-- formula-end -->

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0031" status="verified_source" source-page="13" -->
$$
\begin{pmatrix} p_{n} \\ 1-p_{n} \end{pmatrix} = \begin{pmatrix}
p_{cont}&1-p_{cont} \\
1-p_{cont}&p_{cont}
\end{pmatrix} ^{n-1} \begin{pmatrix} p_{1} \\ 1-p_{1} \end{pmatrix}.
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0031](images/formula_0031.png)
*Formula quality: `verified_source`; source PDF page 13. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:636 (score=1.0).*
<!-- formula-end -->

The eigenvalues of this matrix are 1 and 2 p cont -1:

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0032" status="verified_source" source-page="13" -->
$$
\begin{pmatrix}
p_{cont}&1-p_{cont} \\
1-p_{cont}&p_{cont}
...
*Formula quality: `verified_source`; source PDF page 13. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:643 (score=1.0).*
<!-- formula-end -->

Therefore

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0033" status="verified_source" source-page="13" -->
$$
p_{n} = \dfrac{1 + (2p_{cont} -1)^{n-1} (2 p_{1} -1)}{2} .
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0033](images/formula_0033.png)
*Formula quality: `verified_source`; source PDF page 13. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:657 (score=0.9767).*
<!-- formula-end -->

Moreover for all n ≥ 2,

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0034" status="verified_source" source-page="13" -->
$$
Cov(X_{1},X_{n}) = p_{1}p_{n} + (1-p_{n})(1-p_{1}) -p_{1}(1-p_{n}) - p_{n}(1-p_{1})
$$
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0036" status="verified_source" source-page="13" -->
$$
\sum_{i=1}^{\infty} \sum_{j\geq i} f(i,j) > 1/2
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0036](images/formula_0036.png)
*Formula quality: `verified_source`; source PDF page 13. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:665 (score=1.0).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0037" status="verified_source" source-page="13" -->
$$
\sum_{i=1}^{\infty} \sum_{j\geq i} f(i,j) > 0.7
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0037](images/formula_0037.png)
*Formula quality: `verified_source`; source PDF page 13. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:668 (score=1.0).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0038" status="verified_source" source-page="13" -->
$$
\sum_{i=1}^{\infty} \sum_{j\geq i} f(i,j) = 1/2.
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0038](images/formula_0038.png)
*Formula quality: `verified_source`; source PDF page 13. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:677 (score=1.0).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0039" status="verified_source" source-page="14" -->
$$
Z_{n} = X_{1} + ... + X_{n} and N_{t} = \sup \lbrace k; \ \tau_{1} + ... + \tau_{k} \leq t \rbrace
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0039](images/formula_0039.png)
*Formula quality: `verified_source`; source PDF page 14. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:684 (score=0.8182).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0040" status="verified_source" source-page="14" -->
$$
(s^{n}_{t} :=\dfrac{s_{t_{n}}}{\sqrt{n}}, t \geq 0)_{n \geq 1}
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0040](images/formula_0040.png)
*Formula quality: `verified_source`; source PDF page 14. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:688 (score=0.8936).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0041" status="verified_source" source-page="14" -->
$$
\frac{\tau_1+...+\tau_n}{\zeta(n)}
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0041](images/formula_0041.png)
*Formula quality: `verified_source`; source PDF page 14. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:690 (score=0.8947).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0042" status="verified_source" source-page="14" -->
$$
\begin{aligned}D(f) = \sum_{i=1}^{\infty} \sum_{j=1}^{\infty} ij f(i,j) < \infty\end{aligned}
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0042](images/formula_0042.png)
*Formula quality: `verified_source`; source PDF page 14. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:698 (score=1.0).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0043" status="verified_source" source-page="14" -->
$$
\left( \dfrac{s_{n\log n t}}{\sqrt{n}}, t \geq 0 \right) \mathop{\Rightarrow}^{n \to \infty} \left( \delta \sqrt{\dfrac{ \pi \lambda}{ D(f)}} W_{t}, t \geq 0 \right)
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0043](images/formula_0043.png)
*Formula quality: `verified_source`; source PDF page 14. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:719 (score=0.8182).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0044" status="verified_source" source-page="15" -->
$$
\dfrac{s_{n\log n t}}{\sqrt{n}} = \dfrac{ Z(t \pi \lambda /D(f)) \delta}{\sqrt{n}} + \left( \dfrac{Z(N_{t_
{n}})\delta}{\sqrt{n}} - \dfrac{ Z(t \pi \lambda /D(f)) \delta}{\sqrt{n}} \right)
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0044](images/formula_0044.png)
*Formula quality: `verified_source`; source PDF page 15. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:731 (score=0.9773).*
<!-- formula-end -->
...
$$
\left( \dfrac{Z(N_{t_{n}})\delta}{\sqrt{n}} - \dfrac{ Z(t \pi \lambda /D(f)) \delta}{\sqrt{n}} \right) \mathop{\Rightarrow}^{n \to \infty} 0
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0047](images/formula_0047.png)
*Formula quality: `verified_source`; source PDF page 15. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:748 (score=0.848).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0048" status="verified_source" source-page="15" -->
$$
\left(
\dfrac{s_{n\log n t}}{\sqrt{n}}, t \geq 0 \right)
\mathop{\Rightarrow}^{n \to \infty} \delta \sqrt{ \dfrac{ \pi
\lambda}{ D(f)} } W.
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0048](images/formula_0048.png)
*Formula quality: `verified_source`; source PDF page 15. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:756 (score=0.8133).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0049" status="verified_source" source-page="15" -->
$$
...
*Formula quality: `verified_source`; source PDF page 15. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:771 (score=1.0).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0050" status="verified_source" source-page="16" -->
$$
m(\lambda,\theta + \mu,f) = \sum_{i = 1}^{\infty} \sum_{j=1}^{\infty} m(\lambda,\theta + \mu,i ,j) f(i,j) < \infty,
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0050](images/formula_0050.png)
*Formula quality: `verified_source`; source PDF page 16. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:811 (score=1.0).*
<!-- formula-end -->

where for all ( x,y ) ∈ ( N ∗ ) 2 ,

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0051" status="verified_source" source-page="16" -->
$$
m(\lambda,\theta + \mu,x,y) = \int_{0}^{\infty} dt \int_{t}^{\infty} \psi_{x,\lambda,\mu+\theta}(u) du \int_{t}^{\infty} \psi_{y,\lambda,\mu+\theta}(u) du
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0051](images/formula_0051.png)
*Formula quality: `verified_source`; source PDF page 16. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:813 (score=1.0).*
<!-- formula-end -->

where ψ x,λ,µ + θ is given by (4) . Then

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0052" status="verified_source" source-page="16" -->
$$
\left( \dfrac{s_{nt}}{\sqrt{n}}, t \geq 0 \right) \mathop{\Rightarrow}^{n \to \infty} \left( \sqrt{ \dfrac{1}{m(\lambda, \theta + \mu,f)} }\delta W_{t}, t \geq 0 \right)
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0052](images/formula_0052.png)
*Formula quality: `verified_source`; source PDF page 16. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:815 (score=0.8228).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0053" status="verified_source" source-page="17" -->
$$
\dfrac{ \tau_{1} + \tau_{2} + ... + \tau_{n}}{n} \mathop{\to}^{n \rightarrow \infty} m(\lambda,\theta+\mu,f).
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0053](images/formula_0053.png)
*Formula quality: `verified_source`; source PDF page 17. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:820 (score=0.7731).*
<!-- formula-end -->

<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0054" status="verified_source" source-page="17" -->
$$
\forall t \geq 0,\qquad N^{n}_{t} \mathop{\sim}^{n \to \infty} [\dfrac{t n}{m(\lambda, \theta+\mu,f)}].
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0054](images/formula_0054.png)
*Formula quality: `verified_source`; source PDF page 17. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:822 (score=0.8037).*
<!-- formula-end -->
...
<!-- formula-start id="ref_cont_de_larrard_markovian_lob_1104.4596:formula:0055" status="verified_source" source-page="17" -->
$$
\sigma^{2} = \frac{\tau}{\tau_0} \dfrac{\pi \lambda}{ m(\lambda, \theta+\mu,f) } \delta^{2}
$$
![Source formula ref_cont_de_larrard_markovian_lob_1104.4596:formula:0055](images/formula_0055.png)
*Formula quality: `verified_source`; source PDF page 17. Matched to exact arXiv source 1104.4596v1 at MarkovianOrderBook.tex:832 (score=0.9901).*
<!-- formula-end -->
