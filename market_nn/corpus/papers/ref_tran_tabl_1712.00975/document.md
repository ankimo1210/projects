...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0001" status="semantic_high_confidence" source-page="3" -->
$$
e_{ij}=\mathbf v_{\alpha}^{\mathrm T}\tanh(\mathbf W_{\alpha}\mathbf h_{j-1}^{d}+\mathbf U_{\alpha}\mathbf h_i^{e})
$$
![Source formula ref_tran_tabl_1712.00975:formula:0001](images/formula_0001.png)
*Formula quality: `semantic_high_confidence`; source PDF page 3. Reconstructed the additive-attention energy from encoder state i and the preceding decoder state.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0002" status="semantic_high_confidence" source-page="3" -->
$$
\alpha_{ij}=\frac{\exp(e_{ij})}{\sum_{k=1}^{T}\exp(e_{kj})}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0002](images/formula_0002.png)
*Formula quality: `semantic_high_confidence`; source PDF page 3. Reconstructed the attention softmax over the T encoder time indices for decoder step j.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0007" status="semantic_high_confidence" source-page="4" -->
$$
\bar{\mathbf X}=\mathbf W_1\mathbf X
$$
![Source formula ref_tran_tabl_1712.00975:formula:0007](images/formula_0007.png)
*Formula quality: `semantic_high_confidence`; source PDF page 4. Reconstructed TABL step 1, mapping D input features to D-prime latent features while preserving T time positions.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0008" status="semantic_high_confidence" source-page="4" -->
$$
\mathbf E=\bar{\mathbf X}\mathbf W
$$
![Source formula ref_tran_tabl_1712.00975:formula:0008](images/formula_0008.png)
*Formula quality: `semantic_high_confidence`; source PDF page 4. Reconstructed TABL step 2; the T-by-T temporal matrix produces an energy matrix with the same D-prime-by-T shape.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0009" status="semantic_high_confidence" source-page="4" -->
$$
\alpha_{ij}=\frac{\exp(e_{ij})}{\sum_{k=1}^{T}\exp(e_{ik})}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0009](images/formula_0009.png)
*Formula quality: `semantic_high_confidence`; source PDF page 4. Reconstructed the row-wise temporal softmax, normalizing each latent feature across T positions.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0010" status="semantic_high_confidence" source-page="4" -->
$$
\widetilde{\mathbf X}=\lambda(\bar{\mathbf X}\odot\mathbf A)+(1-\lambda)\bar{\mathbf X}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0010](images/formula_0010.png)
*Formula quality: `semantic_high_confidence`; source PDF page 4. Reconstructed the convex interpolation between attention-weighted and unchanged latent features.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0011" status="semantic_high_confidence" source-page="4" -->
$$
\mathbf Y=\phi(\widetilde{\mathbf X}\mathbf W_2+\mathbf B)
$$
![Source formula ref_tran_tabl_1712.00975:formula:0011](images/formula_0011.png)
*Formula quality: `semantic_high_confidence`; source PDF page 4. Reconstructed the final temporal projection, bias, and element-wise activation of TABL.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0015" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial\bar{\mathbf X}}{\partial\mathbf W_1}=\frac{\partial(\mathbf I_{D'}\mathbf W_1\mathbf X)}{\partial\mathbf W_1}=\mathbf X^{\mathrm T}\otimes\mathbf I_{D'}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0015](images/formula_0015.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed by vectorizing W1 X; the Jacobian maps vec(W1) to vec(X-bar).*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0016" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial\bar{\mathbf X}}{\partial\mathbf X}=\frac{\partial(\mathbf W_1\mathbf X\mathbf I_T)}{\partial\mathbf X}=\mathbf I_T\otimes\mathbf W_1
$$
![Source formula ref_tran_tabl_1712.00975:formula:0016](images/formula_0016.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Corrected the differentiation variable in equation (17) from W1 to X.*
<!-- formula-end -->

- From Eq. (8)

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0017" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial\mathbf E}{\partial\bar{\mathbf X}}=\frac{\partial(\mathbf I_{D'}\bar{\mathbf X}\mathbf W)}{\partial\bar{\mathbf X}}=\mathbf W^{\mathrm T}\otimes\mathbf I_{D'}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0017](images/formula_0017.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed by vectorizing E=X-bar W and differentiating with respect to X-bar.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0018" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial\mathbf E}{\partial\mathbf W}=\frac{\partial(\bar{\mathbf X}\mathbf W\mathbf I_T)}{\partial\mathbf W}=\mathbf I_T\otimes\bar{\mathbf X}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0018](images/formula_0018.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Corrected the differentiation variable in equation (19) from X-bar to W.*
<!-- formula-end -->

- From Eq. (9) ∂ A /∂ E is calculated by the following results:

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0019" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial\alpha_{ij}}{\partial e_{ij}}=\alpha_{ij}-\alpha_{ij}^2=\alpha_{ij}(1-\alpha_{ij}),\qquad\forall i,j
$$
![Source formula ref_tran_tabl_1712.00975:formula:0019](images/formula_0019.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the diagonal derivative of the row-wise softmax.*
<!-- formula-end -->

̸

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0020" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial\alpha_{ij}}{\partial e_{ip}}=-\alpha_{ij}\alpha_{ip},\qquad p\ne j
$$
![Source formula ref_tran_tabl_1712.00975:formula:0020](images/formula_0020.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Replaced the printed off-diagonal softmax derivative with the standard negative cross-coordinate derivative.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0021" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial\alpha_{ij}}{\partial e_{pq}}=0,\qquad p\ne i
$$
![Source formula ref_tran_tabl_1712.00975:formula:0021](images/formula_0021.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the zero derivative between different independently normalized feature rows.*
<!-- formula-end -->

- From Eq. (10)

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0022" status="semantic_high_confidence" source-page="10" -->
$$
\begin{aligned}\frac{\partial\widetilde{\mathbf X}}{\partial\mathbf A}&=\lambda\operatorname{diag}(\operatorname{vec}(\bar{\mathbf X})),\\\frac{\partial\widetilde{\mathbf X}}{\partial\bar{\mathbf X}}&=\operatorname{diag}(\operatorname{vec}(\lambda\mathbf A+(1-\lambda)\mathbf 1_{D'\times T}))+\lambda\operatorname{diag}(\operatorname{vec}(\bar{\mathbf X}))\frac{\partial\mathbf A}{\partial\mathbf E}\frac{\partial\mathbf E}{\partial\bar{\mathbf X}}.\end{aligned}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0022](images/formula_0022.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Corrected equation (24) to use Jacobian matrix multiplication and restored the missing factor lambda in the attention-dependent term.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0023" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial\widetilde{\mathbf X}}{\partial\lambda}=\bar{\mathbf X}\odot\mathbf A-\bar{\mathbf X}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0023](images/formula_0023.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed by differentiating the attention interpolation with A and X-bar held fixed with respect to lambda.*
<!-- formula-end -->

- In Eq. (11), denote ¯ Y = ˜ XW 2 + B , Eq. (11) becomes Y = φ ( ¯ Y ) and we have:

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0024" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial\mathbf Y}{\partial\widetilde{\mathbf X}}=\frac{\partial\phi(\bar{\mathbf Y})}{\partial\bar{\mathbf Y}}\left(\mathbf W_2^{\mathrm T}\otimes\mathbf I_{D'}\right),\qquad\bar{\mathbf Y}=\widetilde{\mathbf X}\mathbf W_2+\mathbf B
$$
![Source formula ref_tran_tabl_1712.00975:formula:0024](images/formula_0024.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the activation Jacobian composed with the vectorized temporal projection.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0025" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial\mathbf Y}{\partial\mathbf B}=\frac{\partial\phi(\bar{\mathbf Y})}{\partial\bar{\mathbf Y}}\left(\mathbf I_{T'}\otimes\mathbf I_{D'}\right)
$$
![Source formula ref_tran_tabl_1712.00975:formula:0025](images/formula_0025.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Corrected the output-time identity from I_T to I_T-prime in the bias Jacobian.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0026" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial\mathbf Y}{\partial\mathbf W_2}=\frac{\partial\phi(\bar{\mathbf Y})}{\partial\bar{\mathbf Y}}\left(\mathbf I_{T'}\otimes\widetilde{\mathbf X}\right)
$$
![Source formula ref_tran_tabl_1712.00975:formula:0026](images/formula_0026.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Corrected the output-time identity from I_T to I_T-prime in the W2 Jacobian.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0027" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial L}{\partial\mathbf W_1}=\frac{\partial L}{\partial\mathbf Y}\frac{\partial\phi(\bar{\mathbf Y})}{\partial\bar{\mathbf Y}}\frac{\partial\bar{\mathbf Y}}{\partial\widetilde{\mathbf X}}\frac{\partial\widetilde{\mathbf X}}{\partial\bar{\mathbf X}}\frac{\partial\bar{\mathbf X}}{\partial\mathbf W_1}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0027](images/formula_0027.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the full chain from loss through output, attention interpolation, and the first bilinear projection.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0028" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial L}{\partial\lambda}=\frac{\partial L}{\partial\mathbf Y}\frac{\partial\phi(\bar{\mathbf Y})}{\partial\bar{\mathbf Y}}\frac{\partial\bar{\mathbf Y}}{\partial\widetilde{\mathbf X}}\frac{\partial\widetilde{\mathbf X}}{\partial\lambda}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0028](images/formula_0028.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the chain-rule gradient for the attention interpolation scalar lambda.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0029" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial L}{\partial\mathbf W}=\frac{\partial L}{\partial\mathbf Y}\frac{\partial\phi(\bar{\mathbf Y})}{\partial\bar{\mathbf Y}}\frac{\partial\bar{\mathbf Y}}{\partial\widetilde{\mathbf X}}\frac{\partial\widetilde{\mathbf X}}{\partial\mathbf A}\frac{\partial\mathbf A}{\partial\mathbf E}\frac{\partial\mathbf E}{\partial\mathbf W}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0029](images/formula_0029.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the chain-rule gradient through the temporal attention matrix W.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0030" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial L}{\partial\mathbf W_2}=\frac{\partial L}{\partial\mathbf Y}\frac{\partial\mathbf Y}{\partial\mathbf W_2}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0030](images/formula_0030.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the direct chain-rule gradient for the final temporal projection.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0031" status="semantic_high_confidence" source-page="10" -->
$$
\frac{\partial L}{\partial\mathbf B}=\frac{\partial L}{\partial\mathbf Y}\frac{\partial\mathbf Y}{\partial\mathbf B}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0031](images/formula_0031.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the direct chain-rule gradient for the output bias.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0032" status="semantic_high_confidence" source-page="10" -->
$$
\mathbf z_i^e=\sigma(\mathbf W_z^e\mathbf x_i+\mathbf U_z^e\mathbf h_{i-1}^e+\mathbf b_z^e)
$$
![Source formula ref_tran_tabl_1712.00975:formula:0032](images/formula_0032.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the encoder GRU update gate.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0033" status="semantic_high_confidence" source-page="10" -->
$$
\widetilde{\mathbf h}_i^e=\tanh(\mathbf W^e\mathbf x_i+\mathbf U^e(\mathbf r_i^e\odot\mathbf h_{i-1}^e)+\mathbf b^e)
$$
![Source formula ref_tran_tabl_1712.00975:formula:0033](images/formula_0033.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the encoder GRU candidate state with reset-gated recurrence.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0034" status="semantic_high_confidence" source-page="10" -->
$$
\mathbf r_i^e=\sigma(\mathbf W_r^e\mathbf x_i+\mathbf U_r^e\mathbf h_{i-1}^e+\mathbf b_r^e)
$$
![Source formula ref_tran_tabl_1712.00975:formula:0034](images/formula_0034.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the encoder GRU reset gate.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0035" status="semantic_high_confidence" source-page="10" -->
$$
\mathbf h_i^e=(1-\mathbf z_i^e)\odot\mathbf h_{i-1}^e+\mathbf z_i^e\odot\widetilde{\mathbf h}_i^e
$$
![Source formula ref_tran_tabl_1712.00975:formula:0035](images/formula_0035.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the encoder GRU interpolation between prior and candidate hidden states.*
<!-- formula-end -->

(38)

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0036" status="semantic_high_confidence" source-page="10" -->
$$
e_{ij}=\mathbf v_{\alpha}^{\mathrm T}\tanh(\mathbf W_{\alpha}\mathbf h_{j-1}^d+\mathbf U_{\alpha}\mathbf h_i^e)
$$
![Source formula ref_tran_tabl_1712.00975:formula:0036](images/formula_0036.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the appendix's additive-attention energy.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0037" status="semantic_high_confidence" source-page="10" -->
$$
\alpha_{ij}=\frac{\exp(e_{ij})}{\sum_{k=1}^{T}\exp(e_{kj})}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0037](images/formula_0037.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the attention normalization over encoder positions for decoder step j.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0038" status="semantic_high_confidence" source-page="10" -->
$$
\mathbf c_j=\sum_{i=1}^{T}\alpha_{ij}\mathbf h_i^e
$$
![Source formula ref_tran_tabl_1712.00975:formula:0038](images/formula_0038.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the context vector as the attention-weighted sum of encoder states.*
<!-- formula-end -->

- Memory
- Decoder

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0039" status="semantic_high_confidence" source-page="10" -->
$$
\mathbf z_j^d=\sigma(\mathbf w_z^d y_{j-1}+\mathbf U_z^d\mathbf h_{j-1}^d+\mathbf C_z\mathbf c_j+\mathbf b_z^d)
$$
![Source formula ref_tran_tabl_1712.00975:formula:0039](images/formula_0039.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the decoder GRU update gate including the context-vector contribution.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0040" status="semantic_high_confidence" source-page="10" -->
$$
\widetilde{\mathbf h}_j^d=\tanh(\mathbf w^d y_{j-1}+\mathbf U^d(\mathbf r_j^d\odot\mathbf h_{j-1}^d)+\mathbf C\mathbf c_j+\mathbf b^d)
$$
![Source formula ref_tran_tabl_1712.00975:formula:0040](images/formula_0040.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the decoder GRU candidate state with reset-gated recurrence and context input.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0041" status="semantic_high_confidence" source-page="10" -->
$$
\mathbf r_j^d=\sigma(\mathbf w_r^d y_{j-1}+\mathbf U_r^d\mathbf h_{j-1}^d+\mathbf C_r\mathbf c_j+\mathbf b_r^d)
$$
![Source formula ref_tran_tabl_1712.00975:formula:0041](images/formula_0041.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the decoder GRU reset gate including the context-vector contribution.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0042" status="semantic_high_confidence" source-page="10" -->
$$
\mathbf h_j^d=(1-\mathbf z_j^d)\odot\mathbf h_{j-1}^d+\mathbf z_j^d\odot\widetilde{\mathbf h}_j^d
$$
![Source formula ref_tran_tabl_1712.00975:formula:0042](images/formula_0042.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the decoder GRU interpolation between prior and candidate hidden states.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0043" status="semantic_high_confidence" source-page="10" -->
$$
y_j=\mathbf w_{out}^{\mathrm T}\mathbf h_j^d+b_{out}
$$
![Source formula ref_tran_tabl_1712.00975:formula:0043](images/formula_0043.png)
*Formula quality: `semantic_high_confidence`; source PDF page 10. Reconstructed the scalar affine decoder output used for sequence forecasting.*
<!-- formula-end -->
