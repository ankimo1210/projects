...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0001" status="text_layer_fallback" source-page="3" -->
![Source formula ref_tran_tabl_1712.00975:formula:0001](images/formula_0001.png)
```text
PDF text layer: e ij = v T α tanh( W α h d j -1 + U α h e i ) (1)
```
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0002" status="text_layer_fallback" source-page="3" -->
![Source formula ref_tran_tabl_1712.00975:formula:0002](images/formula_0002.png)
```text
PDF text layer: α ij = exp( e ij ) ∑ T k =1 exp( e kj ) (2)
```
*Formula quality: `text_layer_fallback`; source PDF page 3. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0007" status="text_layer_fallback" source-page="4" -->
![Source formula ref_tran_tabl_1712.00975:formula:0007](images/formula_0007.png)
```text
PDF text layer: ¯ X = W 1 X (7)
```
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0008" status="text_layer_fallback" source-page="4" -->
![Source formula ref_tran_tabl_1712.00975:formula:0008](images/formula_0008.png)
```text
PDF text layer: E = ¯ XW (8)
```
*Formula quality: `text_layer_fallback`; source PDF page 4. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0009" status="text_layer_fallback" source-page="4" -->
![Source formula ref_tran_tabl_1712.00975:formula:0009](images/formula_0009.png)
```text
PDF text layer: α ij = exp( e ij ) ∑ T k =1 exp( e ik ) (9)
```
*Formula quality: `text_layer_fallback`; source PDF page 4. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0010" status="text_layer_fallback" source-page="4" -->
![Source formula ref_tran_tabl_1712.00975:formula:0010](images/formula_0010.png)
```text
PDF text layer: ˜ X = λ ( ¯ X ⊙ A ) + (1 -λ ) ¯ X (10)
```
*Formula quality: `text_layer_fallback`; source PDF page 4. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0011" status="text_layer_fallback" source-page="4" -->
![Source formula ref_tran_tabl_1712.00975:formula:0011](images/formula_0011.png)
```text
PDF text layer: Y = φ ( ˜ XW 2 + B ) (11)
```
*Formula quality: `text_layer_fallback`; source PDF page 4. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0015" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0015](images/formula_0015.png)
```text
PDF text layer: ∂ ¯ X ∂ W 1 = ∂ ( I D ′ W 1 X ) ∂ W 1 = X T ⊗ I D ′ (16)
```
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0016" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0016](images/formula_0016.png)
```text
PDF text layer: ∂ ¯ X ∂ X = ∂ ( W 1 XI T ) ∂ W 1 = I T ⊗ W 1 (17)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0017" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0017](images/formula_0017.png)
```text
PDF text layer: ∂ E ∂ ¯ X = ∂ ( I D ′ ¯ XW ) ∂ ¯ X = W T ⊗ I D ′ (18)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0018" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0018](images/formula_0018.png)
```text
PDF text layer: ∂ E ∂ W = ∂ ( ¯ XWI T ) ∂ ¯ X = I T ⊗ ¯ X (19)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0019" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0019](images/formula_0019.png)
```text
PDF text layer: ∂α ij ∂e ij = α ij -α 2 ij , ∀ i, j (20)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0020" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0020](images/formula_0020.png)
```text
PDF text layer: ∂α ij ∂e ip = α ij (1 -α ij ) ∑ k = j,p exp( e ik ) , ∀ p = j (21)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0021" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0021](images/formula_0021.png)
```text
PDF text layer: ∂α ij ∂e pq = 0 , ∀ p = i (22)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0022" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0022](images/formula_0022.png)
```text
PDF text layer: ∂ ˜ X ∂ A = λ ∂ ( ¯ X ⊙ A ) ∂ A = λdiag ( vec ( ¯ X ) ) (23) ∂ ˜ X ∂ ¯ X = ∂ ([ λ A +(1 -λ ) 1 D ′ T ] ⊙ ¯ X ) ∂ ¯ X = diag ( vec ( λ A +(1 -λ ) 1 D ′ T ) ) + diag ( vec ( ¯ X ) ) ⊙ ( λ ∂ A ∂ ¯ X ) = diag ( vec ( λ A +(1 -λ ) 1 D ′ T ) ) + diag ( vec ( ¯ X ) ) ⊙ ( ∂ A ∂ E ∂ E ∂ ¯ X ) (24)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0023" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0023](images/formula_0023.png)
```text
PDF text layer: ∂ ˜ X ∂λ = ( ¯ X ⊙ A -¯ X ) (25)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0024" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0024](images/formula_0024.png)
```text
PDF text layer: ∂ Y ∂ ˜ X = ∂ Y ∂ ¯ Y ∂ ¯ Y ∂ ˜ X = ∂φ ( ¯ Y ) ∂ ¯ Y ∂ ( I D ′ ˜ XW 2 ) ∂ ˜ X = ∂φ ( ¯ Y ) ∂ ¯ Y W T 2 ⊗ I D ′ (26)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0025" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0025](images/formula_0025.png)
```text
PDF text layer: ∂ Y ∂ B = ∂ Y ∂ ¯ Y ∂ ¯ Y ∂ B = ∂φ ( ¯ Y ) ∂ ¯ Y ∂ ( I D ′ BI T ) ∂ B = ∂φ ( ¯ Y ) ∂ ¯ Y I T ⊗ I D ′ (28)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0026" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0026](images/formula_0026.png)
```text
PDF text layer: ∂ Y ∂ W 2 = ∂ Y ∂ ¯ Y ∂ ¯ Y ∂ W 2 = ∂φ ( ¯ Y ) ∂ ¯ Y ∂ ( ˜ XW 2 I T ) ∂ W 2 = ∂φ ( ¯ Y ) ∂ ¯ Y I T ⊗ ˜ X (27)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0027" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0027](images/formula_0027.png)
```text
PDF text layer: ∂L ∂ W 1 = ∂L ∂ Y ∂φ ( ¯ Y ) ∂ ¯ Y ∂ ¯ Y ∂ ˜ X ∂ ˜ X ∂ ¯ X ∂ ¯ X ∂ W 1 (29)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0028" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0028](images/formula_0028.png)
```text
PDF text layer: ∂L ∂λ = ∂L ∂ Y ∂φ ( ¯ Y ) ∂ ¯ Y ∂ ¯ Y ∂ ˜ X ∂ ˜ X ∂λ (31)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0029" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0029](images/formula_0029.png)
```text
PDF text layer: ∂L ∂ W = ∂L ∂ Y ∂φ ( ¯ Y ) ∂ ¯ Y ∂ ¯ Y ∂ ˜ X ∂ ˜ X ∂ A ∂ A ∂ E ∂ E ∂ W (30)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0030" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0030](images/formula_0030.png)
```text
PDF text layer: ∂L ∂ W 2 = ∂L ∂ Y ∂ Y ∂ W 2 (32)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0031" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0031](images/formula_0031.png)
```text
PDF text layer: ∂L ∂ B = ∂L ∂ Y ∂ Y ∂ B (33)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0032" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0032](images/formula_0032.png)
```text
PDF text layer: z e i = σ ( W e z x i + U e z h e i -1 + b e z ) (34)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0033" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0033](images/formula_0033.png)
```text
PDF text layer: ˜ h e i = tanh ( W e x i + U e ( r e i ⊙ h e i -1 ) + b e ) (36)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0034" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0034](images/formula_0034.png)
```text
PDF text layer: r e i = σ ( W e r x i + U e r h e i -1 + b e r ) (35)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0035" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0035](images/formula_0035.png)
```text
PDF text layer: h e i = (1 -z e i ) ⊙ h e i -1 + z e i ⊙ ˜ h e i (37)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0036" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0036](images/formula_0036.png)
```text
PDF text layer: e ij = v T α tanh( W α h d j -1 + U α h e i ) (39)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0037" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0037](images/formula_0037.png)
```text
PDF text layer: α ij = exp( e ij ) ∑ T k =1 exp( e kj ) (40)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0038" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0038](images/formula_0038.png)
```text
PDF text layer: c j = T ∑ i =1 α ij h e i (41)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
...
<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0039" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0039](images/formula_0039.png)
```text
PDF text layer: z d j = σ ( w d z y j -1 + U d z h d j -1 + C z c j + b d z ) (42)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0040" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0040](images/formula_0040.png)
```text
PDF text layer: ˜ h d j = tanh ( w d y j -1 + U d ( r d j ⊙ h d j -1 ) + Cc j + b d ) (44)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0041" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0041](images/formula_0041.png)
```text
PDF text layer: r d j = σ ( w d r y j -1 + U d r h d j -1 + C r c j + b d r ) (43)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0042" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0042](images/formula_0042.png)
```text
PDF text layer: h d j = (1 -z d j ) ⊙ h d j -1 + z d j ⊙ ˜ h d j (45)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->

<!-- formula-start id="ref_tran_tabl_1712.00975:formula:0043" status="text_layer_fallback" source-page="10" -->
![Source formula ref_tran_tabl_1712.00975:formula:0043](images/formula_0043.png)
```text
PDF text layer: y j = w T out h d j + b out (46)
```
*Formula quality: `text_layer_fallback`; source PDF page 10. No reliable LaTeX decode; use the source crop and PDF text layer together.*
<!-- formula-end -->
