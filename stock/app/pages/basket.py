            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dcc.DatePickerSingle(
                            id="bk-end", date=date.today().isoformat(), display_format="YYYY-MM-DD"
                        ),
                    ],
                    width=3,
                ),
                ...
                dbc.Col(
                    [
                        ...
                        html.Small(" 5年分は30秒〜1分", className="text-muted ms-2"),
                    ],
                    width=4,
                ),
            ],
                    ...
                    children=[
                        dcc.Tab(
                            ...
                            children=[
                                html.Div(
                                    [
                                        dcc.Graph(id="bk-chart"),
                                        html.Div(id="bk-te", className="mt-3"),
                                    ],
                                    className="pt-3",
                                ),
                            ],
...
def run_compare(n_clicks, start, end, ccy):
    ...
    fig_ret.update_layout(
        title=f"累積リターン比較 {ccy_suffix} ({start} 〜 {end})",
        xaxis_title="日付",
        yaxis_title="累積リターン (%)",
        hovermode="x unified",
        height=500,
