...
Source PDF converted into a Markdown-first folder. Each page includes a rendered page image to preserve figures, tables, formulas, and original layout, plus extracted OCR/text-layer content.
