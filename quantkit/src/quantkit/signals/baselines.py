...
:class:`~quantkit.signals.schema.Signal`. These are the references every fancier model
...
def macro_trend_signal(
    ...
    :func:`quantkit.features.macro.pit_level`). Its trailing change becomes the score,
...
# upstream from fundamentals/yields (e.g. earnings yield from quantkit.data fundamentals,
