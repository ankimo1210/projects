"""quantkit.signals — common signal schema + baseline signals.

Every signal is a standardized, comparable :class:`Signal` (see
:mod:`quantkit.signals.schema`): a cross-sectionally normalized score panel with a
category and direction. Baselines live in :mod:`quantkit.signals.baselines`, combination
and weight helpers in :mod:`quantkit.signals.normalize`, and a name→builder map in
:mod:`quantkit.signals.registry`.
