...
- The baseline has discontinuous instantaneous forwards at knots. The advanced
  ...
  artifacts where observations are sparse. The global smoothing strength is
  fixed at 10.0; a 0.5 multiplier for curvature penalties at 15Y+ was adopted
  from a one-factor test. Its interaction with other smoothing strengths is
  intentionally untested and must not be inferred from this result.
