...
from .diagnostics import build_sensitivity_report, forward_smoothness_check, model_comparison_payload, repricing_table
...
def run_workflow(market_data: Path, output_dir: Path, valuation_date_str: str, report_dir: Path | None) -> int:
    ...
    sensitivity["forward_smoothness_check"] = forward_smoothness_check(
        baseline_full_fit.curve, advanced_full_fit.curve, CALIBRATION_KNOTS
    )
