...
"""
    ...
    sections.append(
        f"""
<h2 id="data">3. Data-quality findings</h2>
...
"""
    ...
    sections.append(
        f"""
<h2 id="comparison">4. Baseline versus advanced</h2>
...
"""
    ...
    sections.append(
        f"""
<h2 id="curve">5. The published curve</h2>
...
"""
    ...
    sections.append(
        f"""
<h2 id="validation">6. Validation, repricing and risk</h2>
...
"""
    ...
    sections.append(
        f"""
<h2 id="sensitivity">7. Sensitivity and stability</h2>
...
"""
    ...
    sections.append(
        f"""
<h2 id="limits">8. Limitations and model risk</h2>
{warnings_html}
<ul>
...
<li><strong>Schedule convention.</strong> The <code>round(T x frequency)</code>
period count is inferred from the supplied quotes, not documented explicitly.
Half-integer <code>T x frequency</code> cases do not occur in this data set, and
the code rounds half away from zero; a conforming file that used banker's
rounding there would disagree.</li>
...
<h2 id="next">9. Recommended next steps</h2>
<ol>
...
"""
    ...
    toc = "".join(
        ...
        for anchor, label in (
            ...
            ("data", "3. Data-quality findings"),
            ("comparison", "4. Baseline versus advanced"),
            ("curve", "5. The published curve"),
            ("validation", "6. Validation, repricing and risk"),
            ("sensitivity", "7. Sensitivity and stability"),
            ("limits", "8. Limitations and model risk"),
            ("next", "9. Recommended next steps"),
        )
    )
