...
export const COCKPIT_CONTROLS: CockpitControlDefinition[] = [
  {
    ...
    label: 'Thrust levers',
    panel: 'pedestal',
    meshNames: ['quadone', 'boxone', 'no1thrarm', 'quadtwo', 'boxtwo', 'no2thrarm'],
    interaction: 'lever',
  ...
  },
  {
    ...
    label: 'Parking brake',
    panel: 'pedestal',
    meshNames: ['parkbrake_0', 'parkbrake_1'],
    interaction: 'toggle',
