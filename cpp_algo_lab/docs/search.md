...
- **bmh**: 唯一 **1.0 の破線を割る**。dna は 0.30〜0.51（m=1024 では 0.4695）で足踏み、ascii は $m=512$ の **0.0104 ≒ $1/95$** まで一直線、english は 0.048（$m=1024$）で $1/\sigma_{\text{eff}} = 1/19$ 弱。
