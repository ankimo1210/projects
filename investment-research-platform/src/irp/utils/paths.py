...
Override the data root with the ``IRP_DATA_DIR`` environment variable (useful for
...
# .../investment-research-platform/src/irp/utils/paths.py -> repo root is parents[3]
REPO_ROOT = Path(__file__).resolve().parents[3]
CONFIG_DIR = REPO_ROOT / "configs"


def data_root() -> Path:
    env = os.environ.get("IRP_DATA_DIR")
