...
学ぶ、Jupyter Book ベースの教科書群。各冊は独立した uv workspace メンバーで、共通の流儀で揃えている。
...
| [`laplace/`](laplace/) | ラプラス変換の風景 — 時間・複素周波数・システムの言語 | 9 |
| [`differential_equation/`](differential_equation/) | 微分方程式 — ODE / PDE の2分冊（変化・流れ・場の言語） | 48 |
| [`machine_learning/`](machine_learning/) | 機械学習の実践 — 正しく定式化し、検証し、解釈する | 10 |

## ポータル

| ディレクトリ | 内容 |
|---|---|
| [`report/`](report/) | **統合インタラクティブ HTML ポータル**。linear_algebra / neural_net / bayesian の代表可視化(22図)をオフラインで束ねるショーケール + 3冊横断キャップストーン。`make report` で生成 |
